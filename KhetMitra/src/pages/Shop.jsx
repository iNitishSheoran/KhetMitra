...
function Shop() {
  const products = [
    ...
    { id: 2, name: "NPK Sensor with OLED Display", image: S2, price: 1800, description: "Soil nutrient sensor with OLED" },
    { id: 3, name: "Soil Moisture Charger", image: S3, price: 220, description: "Device for soil moisture charging" },
    { id: 4, name: "NPK Sensor with App & Web Tracking", image: S4, price: 2500, description: "Tracks soil pH, pressure, altitude, moisture, N, P, K levels" },
  ];
